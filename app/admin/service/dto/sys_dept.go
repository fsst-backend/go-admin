...
type SysDeptGetPageReq struct {
	...
	DeptCatalog               *string      `form:"deptCatalog" search:"type:exact;column:dept_catalog;table:sys_dept" comment:"部门类型"` //部门类型 finance 财务  hr 人力资源 customer_service 客服
	...
	Status                    *int         `form:"status" search:"type:exact;column:status;table:sys_dept" comment:"状态"`              //状态
}
...
type SysDeptInsertReq struct {
	...
	DeptCatalog string `json:"deptCatalog" comment:"部门类型" vd:"?"`                      //部门类型 finance 财务  hr 人力资源 customer_service 客服
...
func (s *SysDeptInsertReq) Generate(model *models.SysDept) {
	...
	model.DeptCatalog = s.DeptCatalog
	model.Sort = s.Sort
...
type DeptTreeRoleSelect struct {
