...
type SysDept struct {
	...
	DeptCatalog string `json:"deptCatalog" gorm:"column:dept_catalog;type:varchar(128);"`       //部门类型 finance 财务  hr 人力资源 customer_service 客服  rnd 研发  sales 销售  market 市场  operation 运营 ops 运维
...
const (
	...
	SysDeptDeptCatalog = "dept_catalog"
	SysDeptSort        = "sort"
