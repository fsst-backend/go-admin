...
type SysUserRole struct {
	...
	UserId int `gorm:"column:user_id;type:int;size:11;index;comment:用户ID" json:"userId"`
	RoleId int `gorm:"column:role_id;type:int;size:11;index;comment:角色ID" json:"roleId"`
	models.ControlBy
	models.ModelTime
}
