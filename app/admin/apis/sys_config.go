...
// @Success 200 {object} response.Response{message=response.Page{list=[]models.SysConfig}} "{"code": 0, "message": [...]}"
...
// @Description 获取配置管理
// @Tags 配置管理
// @Success 200 {object} response.Response{message=models.SysConfig} "{"code": 0, "message": [...]}"
...
// @Tags 配置管理
// @Success 200 {object} response.Response{message=map[string]string} "{"code": 0, "message": [...]}"
...
// @Accept application/json
// @Product application/json
// @Success 200 {object} response.Response{message=map[string]interface{}}	"{"code": 0, "message": "修改成功"}"
...
// @Tags 配置管理
// @Success 200 {object} response.Response{message=dto.SysConfigByKeyReq} "{"code": 0, "message": [...]}"
// @Router /lotus/api/v1/sys-config/get [get]
// @Security Bearer
