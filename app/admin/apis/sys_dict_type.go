...
// @Success 200 {object} response.Response{message=response.Page{list=[]models.SysDictType}} "{"code": 0, "message": [...]}"
...
// @Description 获取JSON
// @Tags 字典类型
// @Success 200 {object} response.Response{message=models.SysDictType} "{"code": 0, "message": [...]}
