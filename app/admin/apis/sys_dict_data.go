...
// @Success 200 {object} response.Response{message=response.Page{list=[]models.SysDictData}} "{"code": 0, "message": [...]}"
...
// @Description 获取JSON
// @Tags 字典数据
// @Success 200 {object} response.Response{message=models.SysDictData} "{"code": 0, "message": [...]}
...
// @Success 200 {object} response.Response{message=[]dto.SysDictDataGetAllResp}  "{"code": 0, "message": [...]}"
